...
public class MenuArea extends GContainer {
	...
	List<Image> tileImages = ImageCache.forClass(Defend.class).getSequential(
			"Wands/wand", 1, 5, ".png");
	...
	private void setTile(int i) {
		...
		// tile num times tile width plus half screen width minus number of
		// tiles times tile width devided by 2
